...
import glob
import myLib.calibrate_720_1280 as calib
...
img_cut = cv2.resize(img, (640, 480))
cv2.imshow('640', img_cut)
img_l = cv2.resize(img, (1280, 720))
cv2.imshow('720', img_l)
# img_cut = img[:720, :]
img = cv2.cvtColor(img_l, cv2.COLOR_BGR2RGB)
